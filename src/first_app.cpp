...
namespace lve
{
    ...
    void FirstApp::createCommandBuffers()
    {
        ...
        {
            throw std::runtime_error("Falha allocate command buffers");
        }
    ...
    void FirstApp::drawFrame()
    {
        ...
        {
            throw std::runtime_error("Falha em adiquirir swap chain image");
        }

        result = lveSwapChain.submitCommandBuffers(&commandBuffers[imageIndex], &imageIndex);
        if (result != VK_SUCCESS)
        {
            throw std::runtime_error("Falha em apresentar swap chain image");
        }
    }
}